...
@RestController
public class PostReprint {
    @PostMapping(value = "/v1/reprint", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<RespReprint> responseMessage(@RequestBody ReqReprint reqReprint) {
